...
watch(
    ...
    (newName) => {
        ...
        if (newName && !form.component_path) {
            form.component_path =
                newName
                    .toLowerCase()
                    .replace(/[^a-z0-9\s-]/g, '')
...
const createBlock = async () => {
    try {
        ...
        schemaFields.value.forEach((field) => {
            if (field.name) {
                ...
                if (
                    ...
                    configSchema[field.name].options = field.options.filter(
                        (opt) => opt.trim(),
                    );
                }
            }
        ...
        const response = await fetch('/admin/page-builder/api/blocks', {
            method: 'POST',
            headers: {
        ...
        if (response.ok) {
            ...
            alert(
                'Failed to create block. Please check the form and try again.',
            );
        }
    } catch (error) {
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="space-y-6">
            ...
            <!-- Form -->
            <div class="max-w-4xl">
                <form @submit.prevent="createBlock" class="space-y-8">
                    <!-- Basic Information -->
                    <div
                                    ...
                                    >
                                        ...
                                        >
                                            <input
                                                ...
                                                "
                                                type="text"
                                                class="flex-1 rounded-md border border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:outline-none dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                    ...
                    <div class="flex justify-end space-x-3">
                        ...
                        <button
                            type="submit"
                            :disabled="!form.name || !form.type || creating"
