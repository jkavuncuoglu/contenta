<template>
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Edit Category</h1>
    ...
    <!-- Loading State -->
    <div v-if="isLoading && !category" class="flex items-center justify-center py-12">
    ...
    <!-- Form -->
    <form v-else-if="category" @submit.prevent="handleSubmit" class="space-y-6">
      <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
        ...
        <div class="p-6 space-y-6">
          ...
          <div>
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
              Upload an image to replace the current one (max 2MB)
            </p>
...
const loadCategory = async () => {
  ...
  if (category.value) {
    form.value = {
      ...
      parent_id: category.value.parent_id || undefined,
