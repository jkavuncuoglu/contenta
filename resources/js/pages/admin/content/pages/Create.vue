...
const requiresCommitMessage = computed(() => {
    return ['github', 'gitlab', 'bitbucket'].includes(
        form.storage_driver || '',
    );
});
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        <div>
                            ...
                            <input
                                ...
                                required
                                @blur="generateSlug"
                                class=" mt-1 block w-full py-2 px-3 py-2 px-3 rounded-md border-neutral-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:border-neutral-600 dark:bg-neutral-700 dark:text-white"
                            />
                            <p
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <select
                                    ...
                                    class="mt-1 block w-full py-2 px-3 rounded-md border-neutral-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:border-neutral-600 dark:bg-neutral-700 dark:text-white"
                                >
                                    <option
                        ...
                        <div class="space-y-4">
                            ...
                            <div v-if="requiresCommitMessage" class="space-y-2">
                                ...
                                <input
                                    ...
                                    class="block w-full py-2 px-3 rounded-md border-neutral-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:border-neutral-600 dark:bg-neutral-700 dark:text-white"
                                />
                                <p
