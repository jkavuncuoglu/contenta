...
const form = useForm({
    ...
    security_rate_limiting:
        props.settings.security_rate_limiting?.value || true,
    security_csrf_protection:
        props.settings.security_csrf_protection?.value || true,
    ...
    honeypot_field_name:
        props.settings.honeypot_field_name?.value || 'hp_field',
    honeypot_minimum_time: props.settings.honeypot_minimum_time?.value || 3,
    honeypot_timer_enabled:
        props.settings.honeypot_timer_enabled?.value || true,
    honeypot_input_field:
        props.settings.honeypot_input_field?.value || 'website',
                            ...
                            <div class="space-y-6">
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <div
                                            v-if="form.errors.recaptcha_version"
                                            class="mt-2 text-sm text-red-600"
                                        >
