...
const form = useForm({
    ...
    default_user_role:
        props.settings.site_default_user_role?.value || 'subscriber',
    ...
    google_tag_manager_id:
        props.settings.site_google_tag_manager_id?.value || '',
    ...
    cookie_consent_enabled:
        props.settings.site_cookie_consent_enabled?.value || true,
});
                ...
                <form @submit.prevent="submit">
                    <div class="space-y-6 px-6 py-6">
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <Input
                                    ...
                                    class="block w-full"
                                    :class="{
                                        'border-red-300': form.errors.site_url,
                                    }"
                                />
                            </div>
                            <p
                        ...
                        <div>
                            ...
                            <div
                                v-if="form.errors.users_can_register"
                                class="mt-2 text-sm text-red-600"
                            >
                        ...
                        <div>
                            ...
                            <div
                                v-if="form.errors.default_user_role"
                                class="mt-2 text-sm text-red-600"
                            >
                                {{ form.errors.default_user_role }}
                            </div>
                        ...
                        <div>
                            ...
                            <div
                                v-if="form.errors.site_language"
                                class="mt-2 text-sm text-red-600"
                            >
                                {{ form.errors.site_language }}
                            </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                ...
                                >
                                    <option
                                        v-for="(label, value) in options.pages"
                                        :key="value"
                                        :value="value"
                                    >
                                        {{ label }}
                        ...
                        >
                            ...
                            <div class="mb-6">
                                ...
                                <div
                                    v-if="form.errors.analytics_enabled"
                                    class="mt-2 text-sm text-red-600"
                                >
                            ...
                            <div class="mb-6">
                                ...
                                <div
                                    v-if="form.errors.google_analytics_id"
                                    class="mt-2 text-sm text-red-600"
                                >
                                    {{ form.errors.google_analytics_id }}
                                </div>
                            ...
                            <div class="mb-6">
                                ...
                                <div
                                    v-if="form.errors.google_tag_manager_id"
                                    class="mt-2 text-sm text-red-600"
                                >
                            ...
                            <div class="mb-6">
                                ...
                                <div
                                    v-if="form.errors.facebook_pixel_id"
                                    class="mt-2 text-sm text-red-600"
                                >
                                    {{ form.errors.facebook_pixel_id }}
                                </div>
                            ...
                            <div>
                                ...
                                <div
                                    v-if="form.errors.cookie_consent_enabled"
                                    class="mt-2 text-sm text-red-600"
                                >
