...
<template>
  <div class="rounded-lg border border-neutral-200 bg-white p-6">
    <h2 class="text-lg font-semibold text-neutral-900">Auto-Posting</h2>
    ...
    <div class="mt-4 space-y-4">
      ...
      <div>
        <label class="flex items-center gap-3">
          ...
          />
          <div>
            <span class="text-sm font-medium text-neutral-900">Enable Auto-Posting</span>
      ...
      <!-- Auto-Post Mode -->
      <div v-if="localForm.auto_post_enabled" class="ml-7 space-y-3 border-l-2 border-neutral-200 pl-4">
        <div class="space-y-2">
          <label class="flex items-start gap-3">
            <input
              ...
              type="radio"
              value="immediate"
              class="mt-0.5 h-4 w-4 border-neutral-300 text-blue-600 focus:ring-blue-500"
            />
            <div>
              <span class="text-sm font-medium text-neutral-900">Post Immediately</span>
              <p class="text-sm text-neutral-500">
          ...
          <label class="flex items-start gap-3">
            ...
            />
            <div class="flex-1">
              <span class="text-sm font-medium text-neutral-900">Schedule for Later</span>
              <p class="text-sm text-neutral-500">
              ...
              <div v-if="localForm.auto_post_mode === 'scheduled'" class="mt-2">
                <label class="block text-sm font-medium text-neutral-700">Daily Post Time</label>
                <input
                  v-model="localForm.scheduled_post_time"
                  type="time"
                  class="mt-1 block w-full max-w-xs rounded-md border-neutral-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                />
