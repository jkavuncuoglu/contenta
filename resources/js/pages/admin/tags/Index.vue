  ...
  <div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div>
          <label for="popular" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Filter</label>
          <select
            id="popular"
    ...
    <!-- Bulk Actions -->
    <div v-if="selectedTags.length > 0" class="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
      <div class="flex items-center justify-between">
    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
      ...
      <div class="overflow-hidden">
        ...
        <div v-else>
                  ...
                  <td class="px-6 py-4 whitespace-nowrap">
                    <div class="flex items-center">
                      ...
                      <div>
                        ...
                        <div v-if="tag.description" class="text-sm text-gray-500 dark:text-gray-400 truncate max-w-xs">
                          {{ tag.description }}
                        </div>
                      </div>
                    </div>
          ...
          <!-- Pagination -->
          <div v-if="pagination.last_page > 1" class="bg-white dark:bg-gray-800 px-4 py-3 border-t border-gray-200 dark:border-gray-700 sm:px-6">
            <div class="flex items-center justify-between">
    ...
    >
      <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        <div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity" aria-hidden="true" @click="showMergeModal = false"></div>
