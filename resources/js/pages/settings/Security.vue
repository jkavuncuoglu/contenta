            ...
            <div class="mb-4 space-y-6 rounded bg-neutral-800/30 p-4">
                ...
                >
                    ...
                    <p class="text-sm text-muted-foreground">
                        ...
                        of security to your account. You'll scan a QR code or
                        enter a setup key into an authenticator app (Google
                    ...
                    <div v-else class="space-y-6 rounded border p-4">
                        ...
                        >
                            ...
                            >
                                If you cannot scan the QR code, enter the key
                                above manually in your authenticator app.
                            </p>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <p class="text-xs text-muted-foreground">
                                Your authenticator app will generate a new code
                                every 30 seconds.
                            </p>
                        </div>
                    </div>
                ...
                <div v-else class="flex flex-col space-y-4">
                    ...
                    >
                        ...
                        <p class="text-xs text-muted-foreground">
                            ...
                            secure password manager. Each can be used one time.
                        </p>
                    ...
                    <div class="space-y-3 rounded border p-4">
                        ...
                        >
                            ...
                            />
                            <Button size="sm" @click="handleRegenerationRequest"
                        ...
                        >
                            ...
                            <Button size="sm" @click="handleConfirmRegeneration"
