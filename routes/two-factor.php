...
//        Route::get('status', [TwoFactorAuthenticationController::class, 'getStatus'])->name('status');
...
//        Route::get('recovery-codes/confirm', [TwoFactorAuthenticationController::class, 'confirmRegeneration'])->name('confirm-regeneration');
//        Route::post('recovery-codes/use', [TwoFactorAuthenticationController::class, 'useRecoveryCode'])->name('recovery-codes.use');
//    });
//});
